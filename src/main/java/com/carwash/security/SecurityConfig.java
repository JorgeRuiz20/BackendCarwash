    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Health Check / Render Keep-Alive (UptimeRobot) y Root
                        .requestMatchers(HttpMethod.GET, "/", "/health", "/health/**", "/api/health", "/api/health/**")
                        .permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/reservas/estado/**")
                        .hasAnyRole("OPERADOR", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/reservas/*/estado")
                        .hasAnyRole("OPERADOR", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/reservas/*/iniciar")
                        .hasAnyRole("OPERADOR", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/bahias/*/estado")
                        .hasAnyRole("OPERADOR", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.GET, "/api/pagos/ingresos/**")
                        .hasAnyRole("OPERADOR", "ADMINISTRADOR")

                        // CLIENTE - Sus propias reservas y pagos
                        .requestMatchers(HttpMethod.POST, "/api/reservas").hasAnyRole("CLIENTE", "ADMINISTRADOR")
                        .requestMatchers(HttpMethod.GET, "/api/reservas/mis-reservas")
